...
像一个长期思考 AI、认知、成长的人，在白纸上随手画出来的一张解释草图。罗小森以简化 chibi 手绘形象出现，不是精细插画，而是保留关键识别特征（白发、眼镜、风衣、灯泡）的快速线稿。
...
- 罗小森以简化手绘 chibi 风格呈现：保留白发、黑框眼镜、黑色风衣/围巾、皮靴、灯泡，不需要画出所有服装细节。

## 颜色

- 黑色：主体线稿、罗小森、框线、结构、主要文字、主体物件。
- 红色：重点批注、问题、情绪点、关键提醒、结果。
- 橙色：主流程、路径、箭头、自动化流向、从 A 到 B 的移动关系。
- 蓝色：补充说明、脑内状态、系统状态、第二层解释、AI/assistant/自动化提示。
- 琥珀/暖黄（极少量）：仅用于罗小森灯泡发光时的光芒效果，不超过 3-4 根细光线。

蓝色不是每张都必须用。琥珀色只在灯泡点亮时出现。颜色要克制，宁可少不要多。
...
- 不要把罗小森画得过于精细（不是角色扮演插画，是功能性草图中的简化角色）。
