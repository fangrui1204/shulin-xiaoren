---
name: shulin-xiaoren
description: 生成罗小森风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成"怪诞""罗小森""手绘""正文配图""文章插图""配图建议""shot list""去标题/改图"等任务；默认使用罗小森 IP（白发眼镜风衣灯泡 chibi）、纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是"罗小森"：白发、黑框眼镜、黑色长风衣、黑色围巾、复古灯泡，chibi 比例，手绘简化风格，认真做一件荒诞但成立的事。罗小森必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaohei-ip.md`：罗小森 IP 的形象、性格、动作库和禁忌。
